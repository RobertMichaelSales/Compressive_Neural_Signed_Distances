...
if __name__=="__main__": 
    ...
    count = 1
    total = len(input_dataset_config_paths)
                            ...
                            for hidden_layers in np.array([8]):
                                ...
                                for activation in np.array(["elu"]):
                                    ...
                                    for bits_per_neuron in np.array([32]):
                                        ...
                                        campaign_name = "EXP[{:03d}]_TCR[{:011.6f}]_ILR[{:11.9f}]_PEF[{:03d}]_NHL[{:03d}]_ACT[{:}]_BPN[{:03d}]".format(experiment_num,compression_ratio,learning_rate,frequencies,hidden_layers,activation,bits_per_neuron)    
